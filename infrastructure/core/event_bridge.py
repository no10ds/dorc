...
class CreateEventBridgeTarget():
    ...
    def __init__(self, universal_stack_reference, event_bridge_target_name: str, event_bridge_rule_name: str, state_machine_arn) -> None:
    ...
    def apply(self):
        cloudevent_trigger_arn = self.universal_stack_reference.get_output("cloudevent_state_machine_trigger_role_arn")
